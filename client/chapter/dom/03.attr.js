...
console.log(first.setAttribute('some', 'hello'));     // 비표준 속성
...
// for of 를 쑬 슈 았나 없나?? (가능, 이터러블하기 때문)
...
first.dataset.play = 'playing;'   // set, 이렇게 하면 자동으로 data-playing 이렇게 만들어짐
