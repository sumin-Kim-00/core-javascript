...
let index = 1;
let template = /* html */ `<div class="box0${index}">새롭게 추가된 element 입니다.</div>`;
...
// - "beforebegin" – elem 바로 앞에 html을 삽입 -> before 라고 할것(유틸함수에서)
// - "afterbegin" – elem의 첫 번째 자식 요소 바로 앞에 html을 삽입 -> first
// - "beforeend" – elem의 마지막 자식 요소 바로 다음에 html을 삽입 -> last
// - "afterend" – elem 바로 다음에 html을 삽입 -> after