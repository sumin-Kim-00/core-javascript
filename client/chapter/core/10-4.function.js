...
// 캐시값들을 저장할 곳
// 객체에 접근하는 방식임(JS 함수는 궁극적으로는 다 객체임)
// 따로 cache 변수 선언하지 않고 함수 안에 캐시함(cache는 걍 내가 이름 지어준거, 바꿀 수 있음)
// 그냥 cache하면 나중에 또 이 이름 쓸 수 있으므로 memoFibo.cache로 빈 객체를 만들어서 이 함수에서만 접근이 가능하게 만들어줌
memoFibo.cache = {
