...
// 배열 선언
let friends = '수민,태형,정국,석진,배열,객체'.split(',')
let arr = new Array(6, 5, 3, 2, 1);   // 생성자 함수 이용해서 배열 생성(잘 안씀)
console.log(friends);
...
// 배열 요소 추가
let unshift = friends.unshift('수민');
console.log(friends);

let push = friends.push('지용');


// 배열 요소 제거
let shift = friends.shift();
console.log(shift);   // 제거 된 값이 반환됨

let pop = friends.pop();
console.log(pop);     // 제거 된 값이 반환됨
